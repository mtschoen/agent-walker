...
def fixture_10_escape_chars():
    ...
    slug = "project-kappa"
    # Session id includes characters the output writer must escape — these
    # appear in the JSON output `session_id` field. We keep this conservative
    # to characters the file-system accepts.
    session_id = "sess-010-with-quote-\\backslash"
    # Skip characters the filesystem rejects (e.g., '/' in session_id).
    # The slug field is just the directory name; the model and session_id
    # fields are what we want to round-trip.
